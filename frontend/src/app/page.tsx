    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative px-4 pb-16 pt-20 text-center">
          <div
            className="pointer-events-none absolute left-1/2 top-24 h-72 w-72 -translate-x-1/2 rounded-full opacity-20 blur-[90px]"
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {t.howTo.steps.map((item, i) => (
                <div
                  key={item.step}
                  className="glow-card anim-fade-up p-5"
        ...
        {/* ── Features ── */}
        <section
          className="border-y border-white/[0.05] px-4 py-14"
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {t.features.items.map((f) => (
                <div
                  key={f.title}
                  className={`glass-card anim-fade-up flex gap-4 p-5 ${f.delay}`}
                >
                  <div
