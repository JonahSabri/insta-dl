  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        <svg
          className={open && mounted ? "h-3 w-3 transition-transform rotate-180" : "h-3 w-3 transition-transform"}
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth={2.5}
        ...
        >
          {LANGS.map((l) => (
            ...
            >
              ...
              {lang === l.code && (
                <svg className="ms-auto h-3.5 w-3.5 text-brand-400 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={3}>
